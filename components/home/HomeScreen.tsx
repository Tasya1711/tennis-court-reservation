...
// See components/intro/Intro.tsx for why `initial` is never conditional on
// useReducedMotion() — only `transition` duration varies here.
export function HomeScreen({
  ...
  const duration = reduceMotion ? 0.15 : 0.5;
    ...
    <main className="min-h-dvh bg-neutral-950">
      ...
      <div className="relative flex h-[42vh] min-h-[300px] w-full flex-col justify-between overflow-hidden px-4 pt-[max(1.25rem,env(safe-area-inset-top))] pb-9">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1, duration, ease: [0.16, 1, 0.3, 1] }}
          className="relative z-10"
        >
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.15, duration: reduceMotion ? 0.15 : 0.6, ease: [0.16, 1, 0.3, 1] }}
